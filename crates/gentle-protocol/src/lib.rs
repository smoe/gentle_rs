...
pub use gene_set_publication::{
    ...
    GeneIsoformAssayPublicationGeneRequest, GeneIsoformAssayPublicationParameter,
    ...
    GeneSetPublicationBundleArtifact, GeneSetPublicationBundleManifest, GeneSetPublicationDownload,
