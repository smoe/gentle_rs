...
impl GentleEngine {
    ...
    pub fn inspect_rna_read_gene_support(
        ...
        Ok(RnaReadGeneSupportAudit {
            ...
            op_id: None,
            run_id: None,
            source_report_generated_at_unix_ms: evaluation.prepared.report.generated_at_unix_ms,
            source_report_op_id: evaluation.prepared.report.op_id.clone(),
            source_report_run_id: evaluation.prepared.report.run_id.clone(),
