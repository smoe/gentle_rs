...
impl GentleEngine {
    ...
    pub(super) fn build_rna_read_seed_histogram_bins(seq_len_bp: usize) -> Vec<RnaReadSeedHistogramBin> {
        if seq_len_bp == 0 {
            return vec![];
        }
    ...
    pub(super) fn make_rna_read_top_hit_preview(hit: &RnaReadInterpretationHit) -> RnaReadTopHitPreview {
