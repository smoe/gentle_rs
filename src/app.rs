...
struct ExternalServicesUiState {
    ...
    project_source_seq_id: String,
    project_source_range: String,
    project_source_as_construct_output: bool,
    project_source_form_id: String,
    project_source_report_id: String,
    project_source_pair_ranks: String,
    route_project_source_output: Option<serde_json::Value>,
    selected_route_candidate: usize,
...
impl Default for ExternalServicesUiState {
    fn default() -> Self {
        Self {
            ...
            project_source_kind: "sequence".to_string(),
            project_source_seq_id: String::new(),
            project_source_range: String::new(),
            project_source_as_construct_output: false,
            project_source_form_id: String::new(),
            project_source_report_id: String::new(),
            project_source_pair_ranks: "1".to_string(),
            route_project_source_output: None,
            selected_route_candidate: 0,
