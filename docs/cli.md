    ...
    - `rna-reads inspect-concatemers` returns a conservative
      ...
      - current signals are:
        ...
        - optional iterative fragment decomposition over the admitted
          transcript-template set, or a broader appended external transcript
          FASTA via `--transcript-fasta`, reporting how many distinct
      ...
      - when `--transcript-fasta` is provided, the top-level payload also
