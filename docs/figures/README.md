...
The README and [`../showcase.md`](../showcase.md) distinguish direct engine
renders from deterministic presentation derivatives and maintained explanatory
schematics. "Generated by GENtle" therefore means that the biological content
comes from shared GENtle state and versioned tooling; it does not imply that
