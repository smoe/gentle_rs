...
3. Attach engine-owned bound self-description (`args`, `reads`, `effects` with
   ...
   `SaveFile`, `Digest`, `digest`, `SelectCandidate`, `Pcr`, `PcrAdvanced`,
   `PcrMutagenesis`, `PcrOverlapExtensionMutagenesis`,
   ...
   `panels import-isoform`, `ImportIsoformPanel`,
   `panels inspect-isoform`, `panels render-isoform-svg`,
   `RenderIsoformArchitectureSvg`, `panels validate-isoform`,
   `transcripts derive`, `transcripts exon-skip-plan`,
   `PlanExonSkippedIsoform`, `exon_skip_plan`,
   `transcripts exon-skip-materialize`, `MaterializeExonSkippedIsoform`,
   `exon_skip_materialize`, `transcripts residue-genomic-coordinates`,
   ...
   `rna-reads show-report`, `rna-reads show-alignment`,
   `rna-reads show-alignments`, `rna-reads summarize-gene-support`,
   `rna-reads inspect-gene-support`, `rna-reads inspect-alignments`,
   `rna-reads inspect-concatemers`, `rna-reads export-report`,
   ...
   `uniprot map`, `ProjectUniprotToGenome`, `uniprot projection-list`,
   ...
   `uniprot audit-projection`, `AuditUniprotProjectionConsistency`,
   `uniprot audit-parity`, `AuditUniprotProjectionParity`,
   `uniprot audit-list`, `uniprot audit-show`, `uniprot audit-export`,
   `uniprot audit-parity-list`, `uniprot audit-parity-show`,
   ...
   `genomes extract-region`, `helpers extract-region`,
   `extract_genome_region`, `ExtractGenomeRegion`,
   `genomes extract-gene`, `helpers extract-gene`,
   `extract_genome_gene`, `ExtractGenomeGene`,
   `genomes extract-promoter`, `helpers extract-promoter`,
   `ExtractGenomePromoterSlice`, `genomes extend-anchor`,
   `helpers extend-anchor`, `extend_genome_anchor`, `ExtendGenomeAnchor`,
   `genomes verify-anchor`, `helpers verify-anchor`,
