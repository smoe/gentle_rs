...
- `08.15` [From annotated transcript starts to reusable TSS windows](./08-15_tss_collection_gui.md) - offline synthetic GUI/CLI walkthrough with an [executable reference](./generated/chapters/08-15_tss_collection_gui.md); Codex source review 2026-09-18; human/live GUI review pending. Use this when: Preview and approve shared/distinct starts, browse saved collections without implying validation, then explicitly validate members. The nine-step automated acceptance subset and manual save/reopen/forget/undo checklist have separate verdicts.
