...
- `04.06` [Design PATZ1 Endpoint and SYBR Transcript Panels from the CLI](./chapters/04-06_patz1_transcript_assay_panels_cli.md) - `core` - example `patz1_endpoint_sybr_transcript_assay_panel_offline` - executed `yes` - review `codex_reviewed` - codex 2026-07-21
