...
Preview and approve distinct annotated starts, then discover and explicitly validate the resulting collection.
...
6. Continue the manual lifecycle checklist: open member windows, verify reverse orientation, save/reopen, edit a member and observe rejection, confirm metadata-only forgetting, then undo. These steps are not yet certified by the automated subset.
...
### Step 6: Continue the manual lifecycle checklist: open member windows, verify reverse orientation, save/reopen, edit a member and observe rejection, confirm metadata-only forgetting, then undo. These steps are not yet certified by the automated subset

**GUI**

Continue the manual lifecycle checklist: open member windows, verify reverse orientation, save/reopen, edit a member and observe rejection, confirm metadata-only forgetting, then undo. These steps are not yet certified by the automated subset.

**Ask the inner agent**

> In the current GENtle project, help me perform this tutorial step: Continue the manual lifecycle checklist: open member windows, verify reverse orientation, save/reopen, edit a member and observe rejection, confirm metadata-only forgetting, then undo. These steps are not yet certified by the automated subset. Show the exact GENtle operation or command and its expected result for my review. State any missing input. Do not execute it until I approve.

**Expected**

> Manual lifecycle acceptance remains separately recorded.
