...
gentle_cli genomes extract-gene "Human GRCh38 Ensembl 116" TP73 --occurrence 1 --output-id tp73_genomic --catalog assets/genomes.json --cache-dir data/genomes
```
...
- Tutorial source JSON: `docs/tutorial/sources/02-04_tp73_cdna_genomic_dotplot_online.json`
