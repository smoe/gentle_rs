...
| Tutorial Markdown outside `docs/tutorial/` | 1 | `docs/agent_interfaces_tutorial.md`, cataloged as `agent_interfaces` |
...
- `docs/tutorial/sources/02_tp73_promoter_luciferase_gui.json` now describes
...
| --- | --- | --- | --- |
| `docs/tutorial/stateless_sequence_inspection_gui_cli.md` | Not cataloged | Add as active guided source unit | Already linked from the tutorial README; covers state-optional sequence inspection across GUI, CLI, and ClawBio. |
| `docs/tutorial/tfbs_similarity_ranking_gui.md` | Not cataloged | Add as active guided source unit | Already linked from the tutorial README; covers GUI sign-off for TFBS similarity ranking. |
...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | `generated_hub` | executable_collection | generated+checked | `docs/tutorial/generated/README.md` | `docs/tutorial/sources/01_generated_hub.json` | - |
| 2 | `vkorc1_warfarin_promoter_luciferase_gui` | gui_walkthrough | manual/hybrid | `docs/tutorial/vkorc1_warfarin_promoter_luciferase_gui.md` | `docs/tutorial/sources/02_tp73_promoter_luciferase_gui.json` | - |
| 3 | `tp73_cdna_genomic_dotplot_gui` | gui_walkthrough | manual | `docs/tutorial/two_sequence_dotplot_gui.md` | `docs/tutorial/sources/03_tp73_cdna_genomic_dotplot_gui.json` | - |
| 4 | `gibson_specialist_testing_gui` | gui_walkthrough | manual/hybrid | `docs/tutorial/gibson_specialist_testing_gui.md` | `docs/tutorial/sources/04_gibson_specialist_testing_gui.json` | - |
| 5 | `gibson_arrangements_gui` | gui_walkthrough | manual/hybrid | `docs/tutorial/gibson_arrangements_gui.md` | `docs/tutorial/sources/05_gibson_arrangements_gui.json` | - |
| 6 | `gibson_physical_rack_gui` | gui_walkthrough | manual/hybrid | `docs/tutorial/gibson_physical_rack_gui.md` | `docs/tutorial/sources/06_gibson_physical_rack_gui.json` | - |
| 7 | `sequencing_confirmation_trace_cli` | cli_walkthrough | manual/hybrid | `docs/tutorial/sequencing_confirmation_trace_cli.md` | `docs/tutorial/sources/06_sequencing_confirmation_trace_cli.json` | - |
| 8 | `sequencing_confirmation_gui` | gui_walkthrough | manual/hybrid | `docs/tutorial/sequencing_confirmation_gui.md` | `docs/tutorial/sources/07_sequencing_confirmation_gui.json` | - |
| 9 | `rna_read_batch_gene_support_cli` | cli_walkthrough | manual/hybrid | `docs/tutorial/rna_read_batch_gene_support_cli.md` | `docs/tutorial/sources/08_rna_read_batch_gene_support_cli.json` | - |
| 10 | `tutorial_landscape_overview` | operational_reference | manual/reference | `docs/tutorial/landscape_overview.md` | `docs/tutorial/sources/09_tutorial_landscape_overview.json` | - |
| 11 | `agent_interfaces` | operational_reference | manual/reference | `docs/agent_interfaces_tutorial.md` | `docs/tutorial/sources/04_agent_interfaces.json` | - |
| 12 | `metabion_external_service_handoff_gui_cli` | gui_cli_walkthrough | manual/hybrid | `docs/tutorial/metabion_external_service_handoff_gui_cli.md` | `docs/tutorial/sources/10_metabion_external_service_handoff_gui_cli.json` | - |
| 13 | `geneart_external_service_handoff_gui_cli` | gui_cli_walkthrough | manual/hybrid | `docs/tutorial/geneart_external_service_handoff_gui_cli.md` | `docs/tutorial/sources/10_geneart_external_service_handoff_gui_cli.json` | - |
| 14 | `simple_pcr_selection_gui` | gui_walkthrough | manual/hybrid | `docs/tutorial/simple_pcr_selection_gui.md` | `docs/tutorial/sources/06_simple_pcr_selection_gui.json` | `18` |
| 15 | `protein_transcript_native_expert_gui` | gui_walkthrough | manual/hybrid | `docs/tutorial/protein_transcript_native_expert_gui.md` | `docs/tutorial/sources/28_protein_transcript_native_expert_gui.json` | - |
| 16 | `protein_reverse_translation_gui` | gui_walkthrough | manual/hybrid | `docs/tutorial/protein_reverse_translation_gui.md` | `docs/tutorial/sources/29_protein_reverse_translation_gui.json` | - |
| 17 | `vkorc1_variant_followup_expert_gui` | gui_walkthrough | manual/hybrid | `docs/tutorial/vkorc1_variant_followup_expert_gui.md` | `docs/tutorial/sources/02_vkorc1_variant_followup_expert_gui.json` | - |
| 18 | `tp73_uniprot_projection_audit_cli` | cli_walkthrough | manual/hybrid | `docs/tutorial/tp73_uniprot_projection_audit_cli.md` | `docs/tutorial/sources/30_tp73_uniprot_projection_audit_cli.json` | `19` |
| 19 | `qpcr_exon_junctions_gui` | gui_walkthrough | manual/hybrid | `docs/tutorial/qpcr_exon_junctions_gui.md` | `docs/tutorial/sources/31_qpcr_exon_junctions_gui.json` | - |
| 20 | `load_branch_reverse_complement_pgex_fasta` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/01_load_branch_reverse_complement_pgex_fasta.md` | `docs/tutorial/sources/11_load_branch_reverse_complement_pgex_fasta.json` | `01` |
| 21 | `find_and_extend_genomic_target_local_catalog` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/02_find_and_extend_genomic_target_local_catalog.md` | `docs/tutorial/sources/12_find_and_extend_genomic_target_local_catalog.json` | `02` |
| 22 | `load_and_digest_pgex` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/03_load_and_digest_pgex.md` | `docs/tutorial/sources/13_load_and_digest_pgex.json` | `03` |
| 23 | `gibson_two_fragment_overlap_preview` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/04_gibson_two_fragment_overlap_preview.md` | `docs/tutorial/sources/14_gibson_two_fragment_overlap_preview.json` | `04` |
| 24 | `guides_filter_and_generate_oligos` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/05_guides_filter_and_generate_oligos.md` | `docs/tutorial/sources/15_guides_filter_and_generate_oligos.json` | `05` |
| 25 | `digest_ligation_extract_region_minimal` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/06_digest_ligation_extract_region_minimal.md` | `docs/tutorial/sources/16_digest_ligation_extract_region_minimal.json` | `06` |
| 26 | `guides_export_csv_and_protocol` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/07_guides_export_csv_and_protocol.md` | `docs/tutorial/sources/17_guides_export_csv_and_protocol.json` | `07` |
| 27 | `contribute_to_gentle_development` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/08_contribute_to_gentle_development.md` | `docs/tutorial/sources/18_contribute_to_gentle_development.json` | `08` |
| 28 | `prepare_reference_genome_online` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/09_prepare_reference_genome_online.md` | `docs/tutorial/sources/19_prepare_reference_genome_online.json` | `09` |
| 29 | `tp53_isoform_architecture_online` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/10_tp53_isoform_architecture_online.md` | `docs/tutorial/sources/20_tp53_isoform_architecture_online.json` | `10` |
| 30 | `tp63_anchor_extension_online` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/11_tp63_anchor_extension_online.md` | `docs/tutorial/sources/21_tp63_anchor_extension_online.json` | `11` |
| 31 | `tp53_multi_gene_sparse_mapping_online` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/12_tp53_multi_gene_sparse_mapping_online.md` | `docs/tutorial/sources/22_tp53_multi_gene_sparse_mapping_online.json` | `12` |
| 32 | `pcr_selection_batch_primer_pairs_offline` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/13_pcr_selection_batch_primer_pairs_offline.md` | `docs/tutorial/sources/23_pcr_selection_batch_primer_pairs_offline.json` | `13` |
| 33 | `tp73_cdna_genomic_dotplot_online` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/14_tp73_cdna_genomic_dotplot_online.md` | `docs/tutorial/sources/24_tp73_cdna_genomic_dotplot_online.json` | `14` |
| 34 | `gibson_specialist_testing_baseline` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/15_gibson_specialist_testing_baseline.md` | `docs/tutorial/sources/25_gibson_specialist_testing_baseline.json` | `15` |
| 35 | `gibson_arrangements_baseline` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/16_gibson_arrangements_baseline.md` | `docs/tutorial/sources/26_gibson_arrangements_baseline.json` | `16` |
| 36 | `tp53_uniprot_projection_online` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/17_tp53_uniprot_projection_online.md` | `docs/tutorial/sources/27_tp53_uniprot_projection_online.json` | `17` |
| 37 | `promoter_design_artifact_slice_offline` | executable_chapter | generated+checked/human-pending | `docs/tutorial/generated/chapters/24_promoter_design_artifact_slice_offline.md` | `docs/tutorial/sources/32_promoter_design_artifact_slice_offline.json` | `24` |
| 38 | `reporter_construct_handoff_cli` | cli_walkthrough | manual/hybrid | `docs/tutorial/reporter_construct_handoff_cli.md` | `docs/tutorial/sources/33_reporter_construct_handoff_cli.json` | - |
...
6. Keep `agent_interfaces` as a tutorial unit, and move
   `docs/agent_interfaces_tutorial.md` into `docs/tutorial/` during the
   dedicated file-rename phase.
7. When the stale source file
   `docs/tutorial/sources/02_tp73_promoter_luciferase_gui.json` is renamed,
